      ...
      <div className='space-y-6'>
        <div className='transactions-account'>
          <div className={cn('flex', 'flex-col', 'gap-2')}>
            <h2 className={cn('text-18', 'font-bold', 'text-white')}>
              {account?.data.name}
            </h2>
            <p className={cn('text-14', 'text-blue-25')}>
          ...
          <div className='transactions-account-balance'>
            ...
            <p className={cn('text-24', 'text-center', 'font-bold')}>
              {formatAmount(account?.data.currentBalance)}
            </p>
          </div>
        </div>
        <section className={cn('flex', 'w-full', 'flex-col', 'gap-6')}>
